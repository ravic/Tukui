...
local fonttags = C["media"].uffontflags
		...
		if (not bar) then
			...
			if (self.Mode == "ICON") then
				...
				if (bar.count) then
					...
					bar.count:SetFont(font, fontsize, fonttags);
				...
				if (bar.bg)then
					...
					bar.bg:SetTemplate("ThickBorder")
				end
				...
				if (bar.time)then
					...
					bar.time:SetFont(font, fontsize, fonttags);
				...
				if (bar.spellname)then
					...
					bar.spellname:SetFont(font, fontsize, fonttags);
