...
TukuiBar2Button:SetTemplate("ThickBorder")
...
TukuiBar2Button.text = T.SetFontString(TukuiBar2Button, C.media.uffont, C.media.uffontsize, C.media.uffontflags)
...
TukuiBar3Button:SetTemplate("ThickBorder")
...
TukuiBar3Button.text = T.SetFontString(TukuiBar3Button, C.media.uffont, C.media.uffontsize, C.media.uffontflags)
...
TukuiBar4Button.text = T.SetFontString(TukuiBar4Button, C.media.uffont, C.media.uffontsize, C.media.uffontflags)
...
TukuiBar5ButtonTop:SetTemplate("ThickBorder")
...
TukuiBar5ButtonTop.text = T.SetFontString(TukuiBar5ButtonTop, C.media.uffont, C.media.uffontsize, C.media.uffontflags)
...
TukuiBar5ButtonBottom:SetTemplate("ThickBorder")
...
TukuiBar5ButtonBottom.text = T.SetFontString(TukuiBar5ButtonBottom, C.media.uffont, C.media.uffontsize, C.media.uffontflags)
...
vehicleleft:SetTemplate("ThickBorder")
...
vehicleleft.text = T.SetFontString(vehicleleft, C.media.uffont, C.media.uffontsize, C.media.uffontflags)
...
vehicleright:SetTemplate("ThickBorder")
...
vehicleright.text = T.SetFontString(vehicleright, C.media.uffont, C.media.uffontsize, C.media.uffontflags)
