...
local FONT_SIZE = C["media"].uffontsize --the base font size to use at a scale of 1
local FONT_FLAG = C["media"].uffontflags
...
local function Timer_OnSizeChanged(self, width, height)
	...
	if fontScale < MIN_SCALE then
		...
		self.text:SetFont(FONT_FACE, FONT_SIZE, FONT_FLAG)
