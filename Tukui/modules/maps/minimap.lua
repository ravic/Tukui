...
TukuiMinimap:CreatePanel("ThickBorder", 1, 1, "CENTER", UIParent, "CENTER", 0, 0)
...
TukuiMinimap.text = T.SetFontString(TukuiMinimap, C.media.uffont, C.media.uffontsize, C.media.uffontflags)
...
-- 4.0.6 Guild isntance difficulty
...
m_zone_text:SetFont(C.media.uffont, C.media.uffontsize, C.media.uffontflags)
...
m_coord_text:SetFont(C.media.uffont, C.media.uffontsize, C.media.uffontflags)
