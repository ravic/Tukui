...
local function CreateRollButton(parent, ntex, ptex, htex, rolltype, tiptext, ...)
	...
	txt:SetFont(C.media.uffont, C.media.uffontsize, C.media.uffontflags)
...
local function CreateRollFrame()
	...
	bind:SetFont(C.media.uffont, C.media.uffontsize, C.media.uffontflags)
	frame.fsbind = bind

	local loot = frame:CreateFontString(nil, "ARTWORK")
	loot:SetFont(C.media.uffont, C.media.uffontsize, C.media.uffontflags)
...
label:SetFont(C.media.uffont, C.media.uffontsize, C.media.uffontflags)
