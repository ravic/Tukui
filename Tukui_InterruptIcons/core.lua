...
function tInterruptIcons.CreateIcon()
	...
	tInterruptIcons.Icons[i]:SetTemplate("ThickBorder")

	tInterruptIcons.Icons[i].TimerText = tInterruptIcons.Icons[i]:CreateFontString("tInterruptIconsTimerText","OVERLAY")
	tInterruptIcons.Icons[i].TimerText:SetFont(C.media.uffont, C.media.uffontsize, C.media.uffontflags)
	tInterruptIcons.Icons[i].TimerText:SetTextColor(1,0,0)
	tInterruptIcons.Icons[i].TimerText:SetShadowOffset(0,0)
...
function tInterruptIcons.StartTimer(icon, duration, texture, spellID)			
	...
	if (texture) then
		...
		tInterruptIcons.Icons[(active or icon)]:SetTemplate("ThickBorder")
	end
